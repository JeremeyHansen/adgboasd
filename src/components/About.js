      ...
      <div>
        ...
        <div className="text-about">
          <p class="animate__animated animate__fadeIn">
            <span>Pure <span className="quality">Quality</span></span> was founded in 2019 by Peter, a Charlotte native who
            has always had a passion for keeping his community clean and
            beautiful. Starting out as a one-man operation, Peter used his
            pressure washing expertise to clean driveways, sidewalks, and homes
            for his neighbors. Over the years, Peter's reputation for quality
            ...
            Peter hired his first employee, and the business has been growing
            ...
            services. With a team of dozens of highly skilled and trained
            ...
            that Peter founded the business on: honesty, integrity, and a
